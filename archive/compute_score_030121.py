...
def main(args):
    ...
    if COV_FILE is not None:
        ...
        # md.compute_stats(adata) # Need to compute statistics before regressing out
        sc.pp.regress_out(adata, keys=cov_list)
    ...
    for trait in df_gs.index:
        ...
        if len(gene_list)<10:
            ...
            continue
        df_res = md.score_cell(adata, gene_list, ctrl_match_key='var', n_ctrl=N_CTRL, 
