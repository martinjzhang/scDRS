...
#SBATCH -o ./job_out.zhong_2020 # Standard output
#SBATCH -e ./job_out.zhong_2020 # Standard error

BATCH_NUM=$SLURM_ARRAY_TASK_ID
H5AD_FILE=../00_prepare_dataset/processed/zhong_2020.processed.h5ad
COV_FILE=../00_prepare_dataset/processed/zhong_2020.cov.tsv

GS_FILE=gs_file/human.gs.batch/batch${BATCH_NUM}.gs

OUT_FOLDER=./score_file/zhong_2020
