...
#SBATCH -o ./job_out # Standard output
#SBATCH -e ./job_out # Standard error

BATCH_NUM=$SLURM_ARRAY_TASK_ID
H5AD_FILE=../00_prepare_dataset/processed/ayhan_2021.raw.h5ad
COV_FILE=../00_prepare_dataset/processed/ayhan_2021.cov.tsv

GS_FILE=gs_file/human.gs.batch/batch${BATCH_NUM}.gs

OUT_FOLDER=./score_file/ayhan_2021
