...
#SBATCH --mem=72000           # Memory pool for all cores (see also --mem-per-cpu)
...
OUT_FOLDER=/n/holystore01/LABS/price_lab/Users/mjzhang/scTRS_data/score_file/score.tms_facs_with_cov.hep_metabolic
