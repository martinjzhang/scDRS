...
#SBATCH --array=10,14          # Memory pool for all cores (see also --mem-per-cpu)
...
OUT_FOLDER=/n/holystore01/LABS/price_lab/Users/mjzhang/scTRS_data/score_file/score.liver_atlas.gwas_max_abs_z.top500
