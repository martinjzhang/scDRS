...
#SBATCH --array=3,6,9,12           # Memory pool for all cores (see also --mem-per-cpu)
...
OUT_FOLDER=${DATA_PATH}/score_file/${DNAME}.${GS_NAME}
# OUT_FOLDER=${DATA_PATH}/score_file/${DNAME}.${GS_NAME}.gs_calib
# OUT_FOLDER=${DATA_PATH}/score_file/${DNAME}.${GS_NAME}.cut
# OUT_FOLDER=${DATA_PATH}/score_file/${DNAME}.${GS_NAME}.remove_outlier
# OUT_FOLDER=${DATA_PATH}/score_file/${DNAME}.${GS_NAME}.nctrl_2500
# OUT_FOLDER=${DATA_PATH}/score_file/${DNAME}.${GS_NAME}.ct_match
# OUT_FOLDER=${DATA_PATH}/score_file/${DNAME}.${GS_NAME}.20varbin
# OUT_FOLDER=${DATA_PATH}/score_file/${DNAME}.${GS_NAME}.nocov
